...
Founder and Software Developer with 7+ years of experience relevant to the Senior SAP Analyst (FICO, PM, MM, HCM) role at Uganda Electricity Distribution Company Limited (UEDCL). Strong background in rest api design and integrations, sql databases and reporting, erp integrations, with hands-on delivery across mobile apps, web systems, automation tools, ERP integrations, and business reporting. Known for turning operational requirements into practical, documented, production-ready software.
