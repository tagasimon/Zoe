...
Founder and Software Developer with 7+ years of experience relevant to the Remote Full-Stack Engineer (Python/Django) role at Arc.dev. Strong background in rest api design and integrations, python / django web development, sql databases and reporting, with hands-on delivery across mobile apps, web systems, automation tools, ERP integrations, and business reporting. Known for turning operational requirements into practical, documented, production-ready software.
...
- Cloud solutions on Google Cloud
