...
Founder and Software Developer with 7+ years of experience relevant to the Remote Software Engineer / Automation Developer role at RemoteAfrica.io. Strong background in flutter / dart mobile development, rest api design and integrations, python / django web development, with hands-on delivery across mobile apps, web systems, automation tools, ERP integrations, and business reporting. Known for turning operational requirements into practical, documented, production-ready software.
