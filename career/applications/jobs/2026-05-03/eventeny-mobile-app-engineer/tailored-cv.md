...
Founder and Software Developer with 7+ years of experience relevant to the Mobile App Engineer role at Eventeny. Strong background in flutter / dart mobile development, rest api design and integrations, cloud solutions on google cloud, with hands-on delivery across mobile apps, web systems, automation tools, ERP integrations, and business reporting. Known for turning operational requirements into practical, documented, production-ready software.
