...
RemoteOps Automation's AI Workflow Automation Engineer role matches the kind of practical software work I do best: building useful systems, integrating tools, and shipping reliable products for real users.

I bring 7+ years of experience across rest api design and integrations, python / django web development, business automation and rpa. At Elastic Technologies, I lead product and client builds across web, mobile, automation, and AI-assisted workflows. At Mulwana Group of Companies, I built cross-platform applications, integrated ERP systems through APIs, and supported Google Cloud migration work. At Nice House of Plastics, I developed sales force automation and reporting systems used for operational decision-making.
