...
Founder and Software Developer with 7+ years of experience relevant to the Full-Stack Software Developer role at Kampala Fintech Labs. Strong background in rest api design and integrations, python / django web development, asp.net core development, with hands-on delivery across mobile apps, web systems, automation tools, ERP integrations, and business reporting. Known for turning operational requirements into practical, documented, production-ready software.
