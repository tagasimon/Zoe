...
Founder and Software Developer with 7+ years of experience relevant to the Flutter Mobile Developer role at Hiring Cafe Sample Product Co. Strong background in flutter / dart mobile development, android / ios app development, rest api design and integrations, with hands-on delivery across mobile apps, web systems, automation tools, ERP integrations, and business reporting. Known for turning operational requirements into practical, documented, production-ready software.
